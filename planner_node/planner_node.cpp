...
class PlannerNode : public rclcpp::Node {
 public:
  ...
  PlannerNode() : Node("planner_node") {
    ...
    cfg.corner_speed_ratio = static_cast<float>(
        declare_parameter("corner_speed_ratio", static_cast<double>(cfg.corner_speed_ratio)));
    ...
    angle_gain_ = static_cast<float>(declare_parameter("angle_gain", static_cast<double>(0.0F)));
 ...
 private:
  ...
  void OnTimer() {
    ...
    if (angle_gain_ > 0.0F && wall_follower_->GetState() == WallFollower::State::kFollowing &&
      ...
      speeds.left_mm_s = std::clamp(static_cast<int16_t>(speeds.left_mm_s + correction),
                                    static_cast<int16_t>(-500), static_cast<int16_t>(500));
      speeds.right_mm_s = std::clamp(static_cast<int16_t>(speeds.right_mm_s - correction),
                                     static_cast<int16_t>(-500), static_cast<int16_t>(500));
    }
